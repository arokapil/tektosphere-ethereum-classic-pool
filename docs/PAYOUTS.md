...
`RESOLVE_PAYOUT=1 ./build/bin/tektosphere-ethereum payouts.json`.
...
Address: 0xb1401222ba1e099655a460b5ab8e0bac2a28ccda, Amount: 166798415 Shannon, 2016-05-11 08:14:34
```

followed by

```
Credited 166798415 Shannon back to 0xb1401222ba1e099655a460b5ab8e0bac2a28ccda
```
...
eth.sendTransaction({
  from: eth.coinbase,
  to: '0xb1401222ba1e099655a460b5ab8e0bac2a28ccda',
...
```
ZADD "eth:payments:all" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:0xb1401222ba1e099655a460b5ab8e0bac2a28ccda:25000000
```

```
ZADD "eth:payments:0xb1401222ba1e099655a460b5ab8e0bac2a28ccda" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:25000000
```

### Delete Erroneous Payment Entry

```
ZREM "eth:payments:pending" "0xb1401222ba1e099655a460b5ab8e0bac2a28ccda:25000000"
```
